...
<div style="text-align: center">
    <img src="assets/RollingDisk1.gif" width=330
         style="clip-path: inset(6px 20px 18px 18px); position: relative;"/>
    <img src="assets/RollingDisk2.gif" width=330
         style="clip-path: inset(6px 80px 18px 80px); position: relative;"/>
</div>
...
<div style="text-align: center">
    <img src="assets/PogoX.gif" width=600
         style="clip-path: inset(10px 50px 15px 50px); position: relative;"/>
</div>
...
<div style="text-align: center">
  <img src="assets/EKF-ST.png" width=500/>
